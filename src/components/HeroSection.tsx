				...
				<div className="lg:col-span-5 relative z-10 flex flex-col  justify-end pb-4 mt-8 lg:mt-0">
					<div className="border-l-4 border-black pl-6 py-2">
						...
						>
							...
							I&apos;m an AI Backend Engineer focused on Agentic AI, LLMs, and Cloud Engineering.
							<br className="hidden md:block" />
							I build production-grade AI systems—combining autonomous agents, FastAPI backends, RAG pipelines, cloud infrastructure, and modern LLM workflows. Always experimenting, always learning, and always shipping practical AI products.
						</p>
					</div>
				</div>
			</div>
